...
def _is_valid_last_name(last_name):
...
class Person:
    def __init__(self, name, last_name, age, gender, email, phone_number):
        self.__name = _is_valid_name(name)
        self.__last_name = _is_valid_last_name(last_name)
        self.__age = _is_valid_age(age)
        self.__gender = _is_valid_gender(gender)
        self.__email = _is_valid_email(email)
        self.__phone_number = _is_valid_phone_number(phone_number)
