...
from tasks.ex10_pandemic_report.pandemic_reporter.pandemic_report.data_loader import DataLoader
from tasks.ex10_pandemic_report.pandemic_reporter.pandemic_report.report_generator import ReportGeneretor
