...
from tasks.ex10_pandemic_report.pandemic_reporter.pandemic_report.bitacora import Bitacora
from tasks.ex10_pandemic_report.pandemic_reporter.pandemic_report.data_collector_factory import DataCollectorFactory
from tasks.ex10_pandemic_report.pandemic_reporter.pandemic_report.custom_exceptions import ExceptionEmptyValues, \
    ExceptionNoInstanceFound
...
class DataLoader(object):
    ...
    def __get_data(self, collector):
        ...
        if not constants.POSSIBLE_STATUS_CODES.get(values[0]).get("is_good"):
