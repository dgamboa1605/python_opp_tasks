class Person(object):
    ...
    def __eq__(self, p_to_compare):
        return self.__id == p_to_compare.id and self.__name == p_to_compare.name and \
               self.__last_name == p_to_compare.last_name and self.__gender == p_to_compare.gender and \
               self.__is_sick == p_to_compare.is_sick
