...
from tasks.ex5_parking_ticket.vehicle import Vehicle
from tasks.ex5_parking_ticket.parking_lot import ParkingLot
from tasks.ex5_parking_ticket.parking_ticket import ParkingTicket
